...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @endif --}}
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="#" id="locationInfo">Location</a>
                        </li> --}}
                        @else
                            ...
                            <div class="dropdown-menu position-absolute" style="z-index: 1401" aria-labelledby="navbarDropdown">
                                @if (Auth::user()->super_admin == 1)
                                    @if (Route::is('reg_usuario'))
                                        ...
                                        <a class="dropdown-item" href="{{ route('indexLocation') }}">Datos de centros</a>
                                    @endif
                                    ...
                                    @if (Route::is('home'))
                                        ...
                                        <a class="dropdown-item" href="{{ route('indexLocation') }}">Datos de centros</a>
                                    @endif
                                    @if (Route::is('indexLocation') || Route::is('editLocation') || Route::is('createLocation'))
                                        <a class="dropdown-item" href="{{ route('home') }}">Ver Mapa</a>
                                        {{-- <a class="dropdown-item" href="{{ route('reg_usuario') }}">Registrar Usuario</a> --}}
                                        <a class="dropdown-item" href="{{ route('update_usuario') }}">Modificar Permisos</a>
                                    @endif
    ...
    <script src="{{ asset('build/assets/app-DzodMDKd.js') }}"></script>
    <script>
